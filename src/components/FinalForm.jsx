...
const FinalForm = () => {
    ...
    const [areas, setAreas] = useState([]); // ✅ Dynamic area list
    ...
    const onNext = (data) => {
        ...
        // If resume is uploaded, convert it to a file URL to display later
        if (data.resume && data.resume[0]) {
            updatedData.resumeName = data.resume[0].name;
            updatedData.resumeFile = URL.createObjectURL(data.resume[0]);
        }
                        ...
                        >
                            ...
                            <div className="grid md:grid-cols-2 gap-6">
                                ...
                                <div>
                                    ...
                                    />
                                    {errors.portfolio && (
                                        <span className="text-red-400 text-sm">{errors.portfolio.message}</span>
                                    )}
                                </div>
                            </div>
                        </motion.div>
